...
export default {
  computed: {
    ...mapState('contracts', ['finishContracts'])
  },
  mounted () {
    this.getFinishContracts()
  },
  methods: {
    ...mapActions('contracts', ['getFinishContracts']),
    ...
    handleView (index, row) {
      this.$store.dispatch('patients/goToFinishPatientDetail', { patientId: row.patientId, contractId: row.contractId }, { root: true })
    }
  }
}
</script>
