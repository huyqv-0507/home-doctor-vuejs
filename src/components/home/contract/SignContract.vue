<template>
  <div>
    <el-table :data="signContracts" :default-sort="{prop: 'dateCreated', order: 'descending'}">
...
export default {
  computed: {
    ...mapState('contracts', ['signContracts'])
  },
  mounted () {
    this.getSignContracts()
  },
  methods: {
    ...mapActions('contracts', ['getSignContracts', 'getRequestDetail']),
