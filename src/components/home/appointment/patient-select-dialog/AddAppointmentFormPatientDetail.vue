<template>
  <el-dialog :visible="isVisibleAddAppointmentFormPatientDetail" @close="closeAddAppointmentFormPatientDetail()" width="30%">
    <template slot="title">
...
export default {
  ...
  computed: {
    ...mapState('modals', ['isVisibleAddAppointmentFormPatientDetail']),
  ...
  methods: {
    ...
    ...mapActions('modals', ['closeAddAppointmentFormPatientDetail']),
